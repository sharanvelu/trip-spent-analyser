            ...
            <div class="flex">
                ...
                @auth
                    ...
                    <x-nav-dropdown title="Apps" align="right" width="48">
                            ...
                            @endcan
                            @can('view-any', App\Models\Space::class)
                            <x-dropdown-link href="{{ route('spaces.index') }}">
                            Spaces
                            </x-dropdown-link>
                            @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('home')" :active="request()->routeIs('home')">
                ...
                @endcan
                @can('view-any', App\Models\Space::class)
                <x-responsive-nav-link href="{{ route('spaces.index') }}">
                Spaces
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Trip::class)
                <x-responsive-nav-link href="{{ route('trips.index') }}">
                Trips
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Expense::class)
