...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::create(['name' => 'list spaces']);
        Permission::create(['name' => 'view spaces']);
        Permission::create(['name' => 'create spaces']);
        Permission::create(['name' => 'update spaces']);
        Permission::create(['name' => 'delete spaces']);
        ...
        $user = \App\Models\User::whereEmail('sharanvelu@outlook.com')->first();
